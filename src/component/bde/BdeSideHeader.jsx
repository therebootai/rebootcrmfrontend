...
const BdeSideHeader = ({ isMobileSidebarOpen, closeMobileSidebar }) => {
  ...
  const sideheader = [
    ...
    },
    {
      ...
      name: "Achievements",
      link: `/bde/achievement/${bdeId}`,
      links: [],
    },
    {
      icon: "/images/support.svg",
      name: "Calling Data",
      link: `/bde/callingdata/${bdeId}`,
      links: [],
    },
  ];
