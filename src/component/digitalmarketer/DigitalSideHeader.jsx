...
const DigitalSideHeader = ({ isMobileSidebarOpen, closeMobileSidebar }) => {
  ...
  const sideheader = [
    {
      ...
      name: "Dashboard",
      link: `/digitalmarketer/digitalmarketer-dashboard/${digitalMarketerId}`,
      links: [],
    },
    {
      icon: "/images/lead.svg",
      name: "Business",
      link: `/digitalmarketer/business/${digitalMarketerId}`,
      links: [],
    },
    {
    ...
    },
    {
      ...
      name: "Achievements",
      link: `/digitalmarketer/achievement/${digitalMarketerId}`,
      links: [],
    },
    {
      icon: "/images/support.svg",
      name: "Calling Data",
      link: `/digitalmarketer/calling-data/${digitalMarketerId}`,
      links: [],
    },
  ];
...
export default DigitalSideHeader;
